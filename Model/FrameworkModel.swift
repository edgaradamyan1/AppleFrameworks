...
struct FrameworkModel: Hashable, Identifiable {
  let id = UUID()
  let name: String
...
struct MockData {
    ...
    static let sampleFramework = FrameworkModel(name: "ARKit",
                                           imageName: "arkit",
    ...
    static let frameworks = [
      ...
      FrameworkModel(name: "SF Symbols",
      ...
      FrameworkModel(name: "Test Flight",
